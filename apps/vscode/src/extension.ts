...
class LoginViewProvider implements vscode.WebviewViewProvider {
  ...
  private render(): void {
    ...
    webview.html = `<!doctype html><html><head><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta http-equiv="Content-Security-Policy" content="default-src 'none'; style-src ${webview.cspSource} 'unsafe-inline'; script-src 'nonce-${nonce}'"><style>
      *{box-sizing:border-box}body{margin:0;padding:14px;color:var(--vscode-foreground);background:var(--vscode-sideBar-background);font-family:var(--vscode-font-family);font-size:13px}.intro{margin-bottom:16px}.intro strong{display:block;margin-bottom:5px;font-size:14px}.intro p{margin:0 0 7px;color:var(--vscode-descriptionForeground);font-size:11px;line-height:1.5}.link{height:auto;padding:0;color:var(--vscode-foreground);background:transparent;font-size:11px}.link:hover{color:var(--vscode-foreground);background:transparent;text-decoration:underline}.field{display:flex;flex-direction:column;gap:5px;margin-bottom:12px}label{font-size:11px;color:var(--vscode-descriptionForeground)}input{width:100%;height:30px;padding:4px 7px;color:var(--vscode-input-foreground);background:var(--vscode-input-background);border:1px solid var(--vscode-input-border);outline:none}input:focus{border-color:var(--vscode-foreground)}.urlRow{display:flex;gap:5px}.urlRow input{flex:1;min-width:0}.icon{width:30px;padding:0;background:transparent;color:var(--vscode-foreground);border:0}.tabs{display:flex;border-bottom:1px solid var(--vscode-panel-border);margin:16px 0 14px}.tab{flex:1;padding:8px 4px;color:var(--vscode-descriptionForeground);background:transparent;border:0;border-bottom:2px solid transparent}.tab.active{color:var(--vscode-foreground);border-bottom-color:var(--vscode-foreground)}.panel[hidden]{display:none}button{height:30px;padding:0 12px;color:var(--vscode-editor-background);background:var(--vscode-foreground);border:0;cursor:pointer}button:hover{opacity:.82}button:disabled{opacity:.55;cursor:default}.primary{width:100%}.secondary{width:100%;color:var(--vscode-foreground);background:transparent;border:1px solid var(--vscode-panel-border)}.qr{width:204px;max-width:100%;margin:0 auto 10px;padding:8px;background:#fff}.qr svg{display:block;width:100%;height:auto}.hint{text-align:center;color:var(--vscode-descriptionForeground);font-size:11px;line-height:1.45}.error{margin:10px 0;padding:8px;color:var(--vscode-errorForeground);background:var(--vscode-inputValidation-errorBackground);border:1px solid var(--vscode-inputValidation-errorBorder)}
