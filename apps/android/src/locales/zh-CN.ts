const zhCN = {
  ...
  workspaces: {
    title: '工作区', create: '新建工作区', deviceTitle: (name: string) => name, deviceInfo: '设备与连接信息', emptyTitle: '还没有工作区', emptyBody: '选择电脑上的项目目录，将相关对话整理在一起。', options: '管理工作区', noSessions: '还没有对话，点击新建', unnamedSession: '未命名对话', codex: 'CodeX',
  ...
  errors: {
    ...
    CODEX_UNAVAILABLE: '这台设备上的 CodeX 当前不可用，请确认电脑端已启用并登录 CodeX。', CODEX_TURN_OWNED: '当前 CodeX 回合正由另一台设备操作，请稍后再试。', CODEX_APPROVAL_NOT_FOUND: '这个 CodeX 确认请求已处理或已过期。', CODEX_PATH_NOT_ALLOWED: '这个目录不在电脑端 CodeX project/list 中。', FEATURE_NOT_SUPPORTED: '电脑端版本不支持此功能，请更新 DSH Remote 插件。', INVALID_MESSAGE: '服务返回了无法识别的数据，请稍后重试。', serverUnreachable: '无法连接服务。请检查服务地址和网络。', unknown: '操作未完成，请重试。',
  },
} as const
