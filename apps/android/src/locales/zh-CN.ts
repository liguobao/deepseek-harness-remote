const zhCN = {
  ...
  workspaces: {
    title: '工作区', create: '新建工作区', createCodex: '新建 CodeX 工作区', deviceTitle: (name: string) => name, deviceInfo: '设备与连接信息', emptyTitle: '还没有工作区', emptyBody: '选择电脑上的项目目录，将相关对话整理在一起。', options: '管理工作区', noSessions: '还没有对话，点击新建', unnamedSession: '未命名对话', codex: 'CodeX',
