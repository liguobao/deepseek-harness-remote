...
To pin a GitHub release instead, install `github:liguobao/deepseek-harness-remote#v0.3.20`.

Restart Harness after installation.

The `0.3.20` Client remains compatible with `0.3.15` Hosts for Remote
